...
My journey started with building user interfaces, but curiosity pushed me deeper into **system design, performance optimization, and scalable backend architecture**. Today, I work at **Shothik AI**, contributing to production-grade applications built with **Next.js, TypeScript, Node.js, and LLM-driven workflows**.
